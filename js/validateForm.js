function validateForm() {
  ...
  if (name.value === "") {
    valid = 0;
    name_validation.innerHTML = "Полето е задължително!";
  ...
  if (message.value === "") {
    valid = 0;
    message_validation.innerHTML = "Полето е задължително!";
  ...
  if (email.value === "") {
    valid = 0;
    email_validation.innerHTML = "Полето е задължително!";
  ...
  if(!filter.test(email.value)) {
    valid = 0;
    email_validation.innerHTML = "Невалидна ел. поща!";
    email_validation.style.display = "block";
    email_validation.parentNode.style.backgroundColor = "#FFDFDF";
  } else {
    email_validation.style.display = "none";
